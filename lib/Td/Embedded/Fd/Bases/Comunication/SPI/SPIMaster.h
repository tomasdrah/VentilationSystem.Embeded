...
namespace TdEmbeddedFd {
    ...
    class SPIMaster {
    public:
        virtual bool TryToInitializeMaster() = 0;

        virtual bool TryToInitializeMaster(SPITransactionSettings settings) = 0;
        ...
        virtual unsigned char TransferByte(unsigned char data) = 0;
